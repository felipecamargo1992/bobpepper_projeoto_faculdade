    ...
    setTimeout(() => {
      ...
      if(mes < 10){
        ...
        if(novoRegistro.leitura < 5){//verifica se a temperatura minima foi excedida
            mensagem.innerHTML = `<span style='color:blue;'>${novoRegistro.leitura}ºC</span> TEMPERATURA BAIXA!<img src='../img/frio.png' width='20px'>`;
            ...
            mensagem.innerHTML = `<span style='color:red;'>${novoRegistro.leitura}ºC</span> TEMPERATURA ALTA! <img src='../img/quente.png' width='20px'>`;
